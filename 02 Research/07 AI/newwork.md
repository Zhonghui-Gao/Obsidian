...
从表中可以看出相较于 YOLOv8 算法，改进后的模
型在其他两个数据集上均有不同程度的提升，在STB-08数据集中P值提高了，在 VOC2007 数据集中 mAP50%提高了 0.4%，
mAP50%-95%提高了 1.1%，说明模型在不同数据集上表现
良好，证明模型有较强的泛化能力和普适性，能够很好的
运用到不同环境的检测上，进一步验证了本文改进模型的
有效性。
