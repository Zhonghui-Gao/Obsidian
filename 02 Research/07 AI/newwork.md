...
由表4可知，改进后的模型权重，计算量均小于其他模型，精确度相较于其他模型比较分别提高了0.4%，1.9%，1.2%，1.5%，2.7%，1.7%，0.1%。在权重大小中，相较于其他模型比较分别减少了71.6%,17%,2.4%,47.7%,27.7%,78.3%,37.5,计算量相较于其他模型分别减少了86.5%，17.1%，3.3%，47.7%, 。改进后的模型相较于主流的网络来说，轻量化更好，准确率更高，为教室部署轻量化网络提供了有效的模型。
