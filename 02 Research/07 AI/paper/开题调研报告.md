...
周晔[15]等人提出了一种利用Faster R-CNN检测框架来检测学生课堂行为的方法。
林[16]等人提出一种基于骨架姿态估计和人物检测的学生行为识别系统，使用OpenPose框架收集骨骼数据，提出了一种基于姿态估计和人物检测技术的纠错方案。
...
Pabba, C., Bhardwaj, V., & Kumar, P. (2024). A visual intelligent system for students’ behavior classification using body pose and facial features in a smart classroom. Multimedia Tools and Applications, 83(12), 36975-37005.



对于老师行为来说：对教师课堂教学行为的研究虽然比不上对学生课堂行为研究那样广泛，但是其作用却永远不能忽视，因此该研究方向一直都是学术研究领域和教育研究领域的热门方向[18]。
...
[15]ZHOU Ye. Research on Classroom Behaviors Detection of Primary School Students Based on Faster R-CNN [D]. Sichuan Normal University,2021. DOI: 10.27347/d.cnki.gssdu.2021.000962.
...
[18]毕煜, 姚馨. 教 师 课 堂 教 学 行 为 的 文 化 研 究 [J]. 教 育 观 察 ,2021,10(39):2123+26.DOI:10.16070/j.cnki.cn45-1388/g4s.2021.39.005.
[19]
[20]
[21]
[22]
