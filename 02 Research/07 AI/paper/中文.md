...
Exp:
在本文工作研究中，我们使用公共数据集——学生课堂行为数据集(SCB-Dataset)。该数据集中包含着三种学生的课堂行为，包括举手、阅读和书写。


本文的研究实验训练的设备为Intel(R) Core(TM) i5-13490F@2.50 GHz CPU和NVIDIA GeForce RTX 4060 8G。Python版本为3.8,0，Pytorch版本为2.3.0+cu121